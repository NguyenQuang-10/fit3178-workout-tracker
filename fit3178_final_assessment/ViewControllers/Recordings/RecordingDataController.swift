...
protocol RecordingDataController {
    func addNewAudioRecord(title: String, uuid: String) // add informations for a new recording
    func getAllRecordingInfo() -> [WorkoutRecording] // get inforamtion about all recording
}
